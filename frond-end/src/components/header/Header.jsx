            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <Link to="/" className="flex-shrink-0">
                        <Logo variant="default"  size="s-1" className="h-10" />
                    </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        ...
                        {!isAuthenticated ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link 
                                    to="/register" 
                                    className="px-5 py-2.5 text-sm font-semibold bg-gray-900 hover:bg-orange-600 text-white rounded-xl transition-all shadow-md hover:shadow-lg"
                                >
                                    S'inscrire
                                </Link>
                            </div>
                            ...
                            <>
                                ...
                                <div className="relative">
                                    <button 
                                        ...
                                        className="flex items-center gap-3 pl-2 pr-4 py-2 rounded-full hover:bg-gray-50 transition-all border border-gray-200"
                                    >
                                    ...
                                    {isProfileOpen && (
                                        <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 animate-in fade-in slide-in-from-top-2">
                                            ...
                                            <div className="border-t border-gray-100 mt-2 pt-2">
                                                <button className="flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 w-full transition-colors">
