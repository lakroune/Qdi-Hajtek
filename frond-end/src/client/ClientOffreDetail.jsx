                            ...
                            >
                                <div className="p-5 border-b border-gray-100 bg-gray-50/50">
                                    ...
                                    <div className="flex gap-2 mt-3">
                                        {prop.bestPrice && (
                                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-green-100 text-green-700 text-[10px] font-bold">
                                                <span className="w-3 h-3">★</span>
                                                Meilleur prix
                                            </span>
                                        )}
                                        {prop.fastest && (
                                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 text-blue-700 text-[10px] font-bold">
                                ...
                                <div className="p-5 space-y-4 flex-1">
                                    ...
                                    <div className="flex items-center gap-3 text-[11px] text-gray-500 pt-2">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span>{prop.artisan.phone}</span>
                                        </div>
                                        <div className="flex items-center gap-1.5 truncate">
                                            <Mail className="w-3.5 h-3.5" />
                                            <span className="truncate">{prop.artisan.email}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-5 pt-0 space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 border border-gray-200 hover:border-red-300 text-gray-600 hover:text-red-600 text-[12px] font-semibold transition-colors">
                                            <XCircle className="w-4 h-4" />
                                            Refuser
                                        </button>
                                        <button className="flex-1 flex items-center justify-center gap-1.5 py-2.5 border border-gray-200 hover:border-[#1B4F72] text-gray-600 hover:text-[#1B4F72] text-[12px] font-semibold transition-colors">
