...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Check, Shield, Star, Clock, Award, User, Phone, MapPin } from 'lucide-react';
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 text-white h-full">
                    ...
                    <div className="max-w-md">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed">
                            Créez votre compte en quelques minutes et accédez à des milliers de services
                            professionnels partout au Maroc.
                        </p>

                        <div className="flex gap-8 mt-8">
                            <div>
                                <p className="text-3xl font-bold text-orange-500">10K+</p>
                                <p className="text-sm text-gray-400">Artisans</p>
                            </div>
                            <div>
                ...
                <div className="w-full max-w-md py-8">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-gray-500">
                            Commencez votre expérience avec Qdi Hajtek en quelques clics.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full pl-12 pr-12 py-3.5 bg-gray-50 border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all ${errors.password ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                    placeholder="••••••••"
                                    required
                                />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full pl-12 pr-12 py-3.5 bg-gray-50 border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'
                                        }`}
                                    placeholder="••••••••"
                                    required
                                />
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            <div className="relative mt-0.5">
                                ...
                                />
                                <div className={`w-5 h-5 border-2 rounded transition-all ${errors.terms ? 'border-red-500' : 'border-gray-300 peer-checked:bg-orange-500 peer-checked:border-orange-500'
                                    }`}></div>
                                <Check className="absolute inset-0 w-5 h-5 text-white opacity-0 peer-checked:opacity-100 p-0.5" />
                            </div>
                            <span className={`text-sm leading-relaxed ${errors.terms ? 'text-red-500' : 'text-gray-600 group-hover:text-gray-800'
                                } transition-colors`}>
                                J'accepte les{' '}
                    ...
                    <div className="mt-6 flex items-center gap-4">
                        ...
                        <span className="text-xs font-medium text-gray-400 uppercase tracking-wider">Ou continuer avec</span>
                        <div className="flex-1 h-px bg-gray-200"></div>
                    </div>

                    {/* Social Login */}
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        <button className="flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all group">
                    ...
                    <p className="mt-6 text-center text-gray-600">
                        ...
                        <Link to="/login" className="font-semibold text-gray-900 hover:text-orange-600 transition-colors ">Se connecter</Link>
                    </p>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100 flex items-center justify-center gap-8 text-xs text-gray-400">
                        ...
                        <a href="#" className="hover:text-gray-600 transition-colors">Aide</a>
                    </div>
